...
e. Suppose in fact $H_0$ is false and $\pi_0 = 0.2$. 

    i. Calculate the probability of committing a Type II error if you use the decision rule from part c. Support your answer showing code/output as necessary. 
   
    ii. How does your answer compare with that from 2d? How do you make sense of the difference and what do you learn from it? 
