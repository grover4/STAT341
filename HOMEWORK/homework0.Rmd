...
- This homework is due in Gradescope on Wednesday Oct 8 by midnight PST. There is a 15 minute grace period and submissions made during this time will not be marked as late. Any work submitted past this period is considered late.  
...
- When you are done, download the PDF file as instructed in quiz section and submit it in Gradescope. \textbf{Do not forget to tag your answers to every sub-part of every question. We will take off 10\% for every part that is not tagged}
...
a. Find $p$, the probability that a randomly selected student will need to retake the class. Show your work.

b. Five housemates are among the students enrolled in the class. Let $X$ denote the number of these five who will need to retake the class. What is a reasonable distribution for $X$? Be sure to state the distribution completely with all inputs specified. 
